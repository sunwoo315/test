...
from oilwells.util.model_helper import get_latest_model
...
def main():
    ...
    if run.id.startswith("OfflineRun"):
        ...
        aml_workspace = Workspace.get(
            name=workspace_name, subscription_id=subscription_id, resource_group=resource_group
        )
        ws = aml_workspace
    ...
    parser.add_argument(
        "--build_id", type=str, help="The Build ID of the build triggering this pipeline run",
    )
    parser.add_argument(
